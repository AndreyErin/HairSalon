    ...
    public class FakeRepoOfRecords : IRepositoryOfRecords
    {
        ...
        public FakeRepoOfRecords() 
        {
            ...
            _records = new()
            {
                ...
                new(){Id = 3, ClientName = "Елена", ClientPhone = "9600000000", ServiceName = "Каре",  DurationOfService = 20, DateForVisit = new(dt2.Year, dt2.Month, dt2.Day), TimeForVisit = new TimeOnly( 10, 30, 0), EmployeeId = 2},
